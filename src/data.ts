...
export const categoryMeta: Record<PropertyCategory, { emoji: string; label: string; accent: string }> = {
  hotel:       { emoji: '🏨', label: 'Hotel',      accent: '#3494ff' },
  office:      { emoji: '🏢', label: 'Office',     accent: '#bf5af2' },
  retail:      { emoji: '🏪', label: 'Retail',     accent: '#ffc434' },
  residential: { emoji: '🏠', label: 'Home',       accent: '#30d158' },
  land:        { emoji: '🌿', label: 'Land',       accent: '#30b0c7' },
  industrial:  { emoji: '🏭', label: 'Industrial', accent: '#ff6b35' },
}

// ── Helper ────────────────────────────────────────────────────────────────────

function p(
  id: string, name: string, cat: PropertyCategory,
  hood: string, city: string, country: string,
  price: number, income: number, prestige: number,
  lng: number, lat: number, desc: string,
): Property {
  return {
    id, name, category: cat, neighborhood: hood, city, country,
    price, incomePerDay: income, prestige, lat, lng, description: desc,
    accentHex: categoryMeta[cat].accent,
    roiPercent: (income * 365) / price * 100,
  }
}
...
export const allCities: City[] = [
  { id: 'istanbul', name: 'Istanbul',  country: 'TR', flag: '🇹🇷', lat: 41.0082, lng:  28.9784, zoom: 13 },
  { id: 'dubai',    name: 'Dubai',     country: 'AE', flag: '🇦🇪', lat: 25.2048, lng:  55.2708, zoom: 13 },
  { id: 'newyork',  name: 'New York',  country: 'US', flag: '🇺🇸', lat: 40.7128, lng: -74.0060, zoom: 13 },
  { id: 'london',   name: 'London',    country: 'GB', flag: '🇬🇧', lat: 51.5074, lng:  -0.1276, zoom: 13 },
  { id: 'tokyo',    name: 'Tokyo',     country: 'JP', flag: '🇯🇵', lat: 35.6895, lng: 139.6917, zoom: 13 },
  { id: 'paris',    name: 'Paris',     country: 'FR', flag: '🇫🇷', lat: 48.8566, lng:   2.3522, zoom: 13 },
  { id: 'baku',     name: 'Baku',      country: 'AZ', flag: '🇦🇿', lat: 40.4093, lng:  49.8671, zoom: 14 },
]
